...
- Derivative (phai sinh): Options _grant you the right, not the obligation_ to buy or sell an asset at set price before a certain expiration date.\
  ...
  Because option is a kind of asset, it means some one can sell it. You can be on the other side of the transaction and sell (also _called_). You will get premium as income but you assume obligation. For example, if a buyer buy a put option and choose to excercise it, you have to buy stock at striked price and sell the stocker to buyer.
### Trading approaches
- Going long (long position): buy low, sell high
- Going short (short selling): Borrows an asset, sell it on the open market at the current price, and plans to repurchase it later at a lower cost.
Short-term trading:
- Day trading: < 1 day
